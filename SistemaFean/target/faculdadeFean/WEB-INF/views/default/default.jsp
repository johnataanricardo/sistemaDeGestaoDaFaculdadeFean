...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <%--Faculdade FEAN com descrição--%>
        <ol class="breadcrumb">
            <li>Início</li>
        </ol>
        <h1>Faculdade FEAN</h1>
        <hr>
        <p class="text-justify">A Faculdade Energia de Administração e Negócios (FEAN) atua desde 2001 na formação e construção profissional do cidadão,
            tornado-o apto para empreender e inovar de forma a contribuir para a formação da sociedade. Localizada no Centro de Florianópolis,
            oferece quatro cursos de graduação: Administração, Ciências Contábeis, Design e Sistemas de Informação.</p>

        <%--Gráfico--%>
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-area-chart"></i> Alunos matriculados</div>
            <div class="card-body">
